        ...
        <div>
            ...
            <div className="font-algeria carousel w-full lg:h-[550px] ">
                ...
                <div id="slide1" className="carousel-item relative w-full">
                    <Link to="/spotDetails/662d0e07c8172d24f14b619b">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <Link to="/spotDetails/663089bd401b9d9fc60534eb">
                        <div className="flex flex-col lg:flex-row p-4 lg:p-24 gap-20">
                            <div className="space-y-7 flex-1">
                                <h2 className="text-2xl text-secondary lg:text-4xl font-bold">{text1}</h2>
                                <p className=" text-4xl font-medium text-error ">Bangkok
                                    ,
                                    Thailand</p>
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <Link to="/spotDetails/66308a4a401b9d9fc60534ec">
                        <div className="flex flex-col lg:flex-row p-4 lg:p-24 gap-20">
                            <div className="space-y-7 flex-1">
                                <h2 className="text-2xl text-secondary lg:text-4xl font-bold">{text2}</h2>
                                <p className=" text-4xl font-medium text-error ">Bali
                                    ,
                                    Indenesia</p>
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <Link to="spotDetails/66308adf401b9d9fc60534ed">
                        <div className="flex flex-col lg:flex-row p-4 lg:p-24 gap-20">
                            <div className="space-y-7 flex-1">
                                <h2 className="text-2xl text-secondary lg:text-4xl font-bold">{text3}</h2>
                                <p className=" text-4xl font-medium text-error ">Kuala Lumpur
                                    ,
                                    Malaysia</p>
